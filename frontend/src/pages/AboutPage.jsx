      ...
      <div className="relative h-[80vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-8 pb-16 w-full">
          ...
          <motion.h1 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.9 }}
            ...
            Adventure<br /><span className="italic text-brand-400">is Calling</span>
          </motion.h1>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-display text-2xl text-brand-400 italic">Let's explore. Let's grow.</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <motion.div key={i} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                  ...
                  <div className="font-display text-4xl text-brand-400 font-300 mb-1">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}
              className="p-8 border border-brand-500/20 bg-brand-500/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {VALUES.map((v, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                className="p-6 border border-white/5 hover:border-brand-500/30 bg-stone-900/20 transition-all group">
                <div className="text-3xl mb-4">{v.icon}</div>
                <h3 className="font-sans text-cream font-500 mb-2 group-hover:text-brand-300 transition-colors">{v.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(team.length === 0 ? [
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }}
                ...
                <p className="text-brand-400 text-sm font-sans mb-3">{member.designation}</p>
